...
#define NCAPS_L 2
#define NCAPS_S 0
#define VOLUME_FRACTION_L 0.0001 //corresponding to radius 0.1
...
#define DEBUG_AABB 1
#define DEBUG_AABB_FREQ OUTPUT_FREQ_PV_DUMP

#define DEBUG_APPLY_SPARSE_OWNER_LAGVEL 1
#define DEBUG_OWNER_ONLY_ADVECTION 1
#define DEBUG_CAPSULE_LIFECYCLE_DRYRUN 1
#define DEBUG_APPLY_SOFT_CAPSULE_LIFECYCLE 1
#define DEBUG_FREE_INACTIVE_CAPSULE_STORAGE 1
#ifndef DEBUG_OWNER_POSTPROC
  #define DEBUG_OWNER_POSTPROC 1
#endif
