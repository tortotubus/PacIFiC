...
sed -i 's|${GRAINS_HOME}/XERCES-2.8.0|/home/gitlab-runner/dependencies/XERCES-2.8.0|' ${GRAINS_HOME}/Env/grains_default.env.sh
sed -i 's|${GRAINS_HOME}/XERCES-2.8.0|/home/gitlab-runner/dependencies/XERCES-2.8.0|' ${GRAINS_HOME}/Env/grains_default.env.csh
...
sed -i 's|PETSC_DIR=${MACWORLD_ROOT}/petsc-3.2.0-p7|HYPRE_DIR=/home/gitlab_runner/dependencies/petsc-3.2.0-p7|' ${PACIFIC_HOME}/Cartesian/MacWorld/extra_files/petsc.env.sh
