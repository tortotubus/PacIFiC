#
# Modules to load for sockeye.arc.ubc.ca
#

module purge
module load CVMFS_CC/2023 cmake hdf5-mpi/1.14.2 petsc/3.23.4

#
# Note: this is neccesary to pick up the correct libstc++ 
#

export LDFLAGS="-Wl,-rpath,/cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr/lib/gcc/x86_64-pc-linux-gnu/12/ ${LDFLAGS}"
...
export PACIFIC_INSTALLDIR="install/PacIFiC-${PACIFIC_ARCH}"
...
then
export PACIFIC_XERCESC_CFLAGS="-I/cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr/include"
export PACIFIC_XERCESC_LFLAGS="-L/cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr/lib64 -Wl,-rpath,/cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr/lib64 -lxerces-c"
export PACIFIC_XERCESC_PREFIX="/cvmfs/soft.computecanada.ca/gentoo/2023/x86-64-v3/usr/"
export PACIFIC_XERCESC_VER="3.2.4"
else
export PACIFIC_XERCESC_CFLAGS="-I${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/include"
export PACIFIC_XERCESC_LFLAGS="-L${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib64 -Wl,-rpath,${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib64 -lxerces-c"
...
export PACIFIC_HDF5_LFLAGS="-L${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib -Wl,-rpath,${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib -lhdf5"
...
export PACIFIC_ZLIB_LFLAGS="-L${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib -Wl,-rpath,${PACIFIC_THIRDPARTY_INSTALLDIR_ABS}/lib -lz-ng"
