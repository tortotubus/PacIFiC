...
export PACIFIC_HDF5_LFLAGS="-L/usr/lib64/openmpi/lib -Wl,-rpath,/usr/lib64/openmpi/lib -lhdf5"
export PACIFIC_HDF5_PREFIX="/usr/lib64/openmpi"
export PACIFIC_HDF5_VER="1.14.5"
else
