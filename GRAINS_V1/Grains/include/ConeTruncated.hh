#ifndef _CONETRUNCATED_HH_
#define _CONETRUNCATED_HH_

#include "Convex.hh"
#include "ReaderXML.hh"


/** @brief The class Cone Truncated.

    Convex with a truncated conical shape.

    @author D.PETIT - Institut Francais du Petrole - 2000 - Creation
    @author A.WACHS - 2019 - Major cleaning & refactoring 
    @author M.BARCET - 2023 - Addition of this class based on the simple cone*/
// ============================================================================
class ConeTruncated : public Convex
{
  public:
    /**@name Constructors */
    //@{
    ...
    @param h height */
    ConeTruncated( double r_bot = 0, double r_top = 0, double h = 0 ); 

    /** @brief Constructor with an input stream
    @param fileIn input stream */
    ConeTruncated( istream& fileIn );

    /** @brief Constructor with an XML node as an input parameter
    @param root XML node */
    ConeTruncated( DOMNode* root );
  ...
  protected:
    /** @name Parameters */
    //@{
    double m_botRadius; /**< radius of the flat base */
    double m_topRadius; /**< radius of the flat base */
    double m_halfHeight;/**< cylinder half height */
    double m_botHeight; /**< from CoG to bot */
    double m_topHeight; /**< from CoG to top */
    double m_Hprim;     /**< from bottom to top of the full cone */
    double m_sinAngle;  /**< angle for GJK support function */
