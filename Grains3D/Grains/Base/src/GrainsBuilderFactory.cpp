...
Grains *GrainsBuilderFactory::create(DOMElement *root) {
  ...
  if (option == "Standard")
    ...
    grains = new GrainsMPI();
  else if (option == "Parameters")
    grains = new GrainsParameters();
  else if (option == "CompositeRigidBody")
    grains = new GrainsCRBFeatures();
  else if (option == "TestDev")
    grains = new GrainsTestDev();
  else if (option == "PostProcessing")
    grains = new GrainsPostProcessing();
...
GrainsCoupledWithFluid *
GrainsBuilderFactory::createCoupledWithFluid(DOMElement *root,
...
EAPPLI GrainsBuilderFactory::getContext() { return (m_context); }
