...
std::filesystem::path get_dtd_dir() {
  ...
  std::vector<std::filesystem::path> candidates = {
      ...
      libdir / "../share/Grains3DGPU/Dtd",    // install prefix
      libdir / "../../../share/Grains3DGPU/Dtd", // mpi-install prefix
      libdir / "../../usr/share/Grains3DGPU/Dtd" // debian multi-arch 
  };
...
std::filesystem::path get_tools_dir() {
  ...
  std::vector<std::filesystem::path> candidates = {
      ...
      libdir / "../share/Grains3DGPU/Tools",    // install prefix
      libdir / "../../../share/Grains3DGPU/Tools", // mpi-install prefix (/usr/lib64/openmpi/lib/ + ../../../share/Grains/Tools)
      libdir / "../../usr/share/Grains3DGPU/Tools" // debian multi-arch 
  };
