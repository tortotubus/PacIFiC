...
This script, Train_Tz.py, includes functions that:
- Convert data into a graph structure.
- Design and train Graph Neural Networks (GNNs) for a regression-based task to predict the hydrodynamic torque.
"""
...
def train_model_four_sequential(
    ...
    results = []
    json_filename = f"{directory_name}Tz_det_results_{hidden_channels}channels_neighbours_{N_neigh}_optm.json"
...
if __name__ == "__main__":
    ...
    def prepare_data(df, df2, force='Ct0', flip_y=False):
        """
        ...
        force : str, optional
            Name of the force component to be used (default is 'Ct0').
