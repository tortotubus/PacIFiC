...
# Layal Jbara
#
# This file, Train_Quaternary_Lift.py, contains functions for training a Quaternary regression Lift model.
...
#####################################################################################################
"""
Train_Quaternary_Lift.py contains functions for training a Quaternary regression Lift model.
"""
#####################################################################################################
...
def data_train(qfold, N_2, N_3, N_4, B_S, Cds=2.74931):
    ...
    log_dir = f"../results/logs/Lift/Quaternary_q_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}"
    log_path = f"../results/logs/Lift/Quaternary_log_q_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.txt"
    cp_filepath = f'../results/Checkpoints/Lift/CP-Quaternary_model_fold_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.h5'
    ...
    X_train_quat       = np.load(f'../results/Tensors/Lift/X_train_quat_q_{q}_N2_{N_2}_N3_{N_3}_N4_{N_4}.npy')
    X_test_quat        = np.load(f'../results/Tensors/Lift/X_test_quat_q_{q}_N2_{N_2}_N3_{N_3}_N4_{N_4}.npy')
    ...
    # Saving Model
    model.save(f"../results/Models/Lift/Quaternary_model_fold_{q}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.h5")
