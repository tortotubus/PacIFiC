...
# Layal Jbara
#
# This file, Train_Ternary_Torque.py, contains functions for training a Ternary regression Torque model.
...
#####################################################################################################
"""
Train_Ternary_Torque.py contains functions for training a Ternary regression Torque model.
"""
#####################################################################################################
...
def data_train(qfold, N_2, N_3, N_4, B_S):
    ...
    log_dir = f"../results/logs/Torque/Ternary_q_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}"
    log_path = f"../results/logs/Torque/Ternary_log_q_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.txt"
    cp_filepath = f'../results/Checkpoints/Torque/CP-Ternary_model_fold_{qfold}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.h5'
    ...
    # Saving Model
    model.save(f"../results/Models/Torque/Ternary_model_fold_{q}_N2_{N_2}_N3_{N_3}_N4_{N_4}_BS_{B_S}.h5")
