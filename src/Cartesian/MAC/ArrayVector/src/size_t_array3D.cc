...
//----------------------------------------------------------------------
   ...
   , d2( dim2 )
{
   MAC_LABEL( "size_t_array3D:: size_t_array3D" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "size_t_array3D:: re_initialize" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "size_t_array3D:: raise_first_index_bound" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "operator<<( std::ostream&, size_t_array3D const& )" ) ;
