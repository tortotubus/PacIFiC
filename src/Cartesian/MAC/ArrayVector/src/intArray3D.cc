...
//----------------------------------------------------------------------
   ...
   , d2( dim2 )
{
   MAC_LABEL( "intArray3D:: intArray3D" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "intArray3D:: re_initialize" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "intArray3D:: raise_first_index_bound" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "operator<<( std::ostream&, intArray3D const& )" ) ;
