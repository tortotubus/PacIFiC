...
//----------------------------------------------------------------------
   ...
   , d2( dim2 )
{
   MAC_LABEL( "doubleArray3D:: doubleArray3D" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "doubleArray3D:: operator=" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "doubleArray3D:: re_initialize" ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "doubleArray3D:: raise_first_index_bound" ) ;
   MAC_CHECK_PRE( dim0 > index_bound(0) ) ;
   MAC_CHECK_PRE( index_bound(1) > 0 && index_bound(2) > 0 ) ;
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "operator<<( std::ostream&, doubleArray3D const& )" ) ;
