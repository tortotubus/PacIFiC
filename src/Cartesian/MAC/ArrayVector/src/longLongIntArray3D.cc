...
//----------------------------------------------------------------------
longLongIntArray3D:: longLongIntArray3D( size_t dim0, size_t dim1, size_t dim2, 
	long long int val )
//----------------------------------------------------------------------
   ...
   , d2( dim2 )
{
   MAC_LABEL( "longLongIntArray3D:: longLongIntArray3D" ) ;
...
//----------------------------------------------------------------------
longLongIntArray3D:: longLongIntArray3D( longLongIntArray3D const& other )
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
longLongIntArray3D:: ~longLongIntArray3D( void )
//----------------------------------------------------------------------
{
}
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "longLongIntArray3D:: operator=" ) ;
   if( this != &other )
   {
      vector = other.vector ;
      d0 = other.d0 ;
   ...
   longLongIntArray3D& result = *this ;
...
//----------------------------------------------------------------------
bool
longLongIntArray3D:: operator==( longLongIntArray3D const& other ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "longLongIntArray3D:: operator==" ) ;
...
//----------------------------------------------------------------------
void
longLongIntArray3D:: re_initialize( size_t dim0, size_t dim1, size_t dim2,
	long long int val ) 
//----------------------------------------------------------------------
{
   MAC_LABEL( "longLongIntArray3D:: re_initialize" ) ;
...
//----------------------------------------------------------------------
void
longLongIntArray3D:: raise_first_index_bound( size_t dim0, long long int val ) 
//----------------------------------------------------------------------
{
   MAC_LABEL( "longLongIntArray3D:: raise_first_index_bound" ) ;
...
//----------------------------------------------------------------------
void
longLongIntArray3D:: set( long long int val )
//----------------------------------------------------------------------
{
   MAC_LABEL( "longLongIntArray3D:: set" ) ;
...
//----------------------------------------------------------------------
std::ostream&
operator<<( std::ostream& out, longLongIntArray3D const& a )
//----------------------------------------------------------------------
{
   MAC_LABEL( "operator<<( std::ostream&, longLongIntArray3D const& )" ) ;
