#ifndef FV_DISCRETE_FIELD_VORTICITY_HH
#define FV_DISCRETE_FIELD_VORTICITY_HH
...
/** @brief The Class FV_DiscreteField_Vorticity.

Discrete field of the vorticity-valued FV/Finite Volume type. DOF are located
at the center of the edges (same locations as the off-diagonal tensor
components).

@author A. Wachs - Particulate flow project 2010-2012 */

class FV_DiscreteField_Vorticity : public FV_DiscreteField
{
   public: //-----------------------------------------------------------
   ...
   //-- DOFs status
      ...
      virtual bool DOF_is_unknown_handled_by_proc( size_t i, size_t j, 
   ...
   private: //----------------------------------------------------------
      ...
      FV_DiscreteField_Vorticity( void ) ;
     ~FV_DiscreteField_Vorticity( void ) ;
      FV_DiscreteField_Vorticity( FV_DiscreteField_Vorticity const& other );
      FV_DiscreteField_Vorticity& operator=( 
      	FV_DiscreteField_Vorticity const& other ) ;

      FV_DiscreteField_Vorticity( MAC_Object* a_owner,
      ...
      FV_DiscreteField_Vorticity( std::string const& a_type ) ;	
   ...
   //-- Attributes
      ...
      static FV_DiscreteField_Vorticity const* PROTOTYPE ;
