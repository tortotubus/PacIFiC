#ifndef FV_DISCRETE_FIELD_TENSOR_HH
#define FV_DISCRETE_FIELD_TENSOR_HH
...
/** @brief The Class FV_DiscreteField_Tensor.

Discrete field of the tensor-valued FV/Finite Volume type. Ordering is as
follows: d11, d22, d12 in 2D, and d11, d22, d33, d12, d13, d23 in 3D.

@author A. Wachs - Particulate flow project 2010-2012 */

class FV_DiscreteField_Tensor : public FV_DiscreteField
{
   public: //-----------------------------------------------------------
   ...
   private: //----------------------------------------------------------
      ...
      FV_DiscreteField_Tensor( void ) ;
     ~FV_DiscreteField_Tensor( void ) ;
      FV_DiscreteField_Tensor( FV_DiscreteField_Tensor const& other ) ;
      FV_DiscreteField_Tensor& operator=( 
      	FV_DiscreteField_Tensor const& other ) ;

      FV_DiscreteField_Tensor( MAC_Object* a_owner,
      ...
      FV_DiscreteField_Tensor( std::string const& a_type ) ;	
      ...
      void set_DOF_status_on_Neumann_BC_3D( size_t comp,
   ...
   //-- Attributes
      ...
      static FV_DiscreteField_Tensor const* PROTOTYPE ;
