#ifndef FV_DISCRETE_FIELD_VERTEX_HH
#define FV_DISCRETE_FIELD_VERTEX_HH
...
/** @brief The Class FV_DiscreteField_Vertex.

Discrete field of the vertex based FV/Finite Volume type.

@author A. Wachs - Particulate flow project 2010-2012 */

class FV_DiscreteField_Vertex : public FV_DiscreteField
{
   public: //-----------------------------------------------------------
   ...
   private: //----------------------------------------------------------
      ...
      FV_DiscreteField_Vertex( void ) ;
     ~FV_DiscreteField_Vertex( void ) ;
      FV_DiscreteField_Vertex( FV_DiscreteField_Vertex const& other ) ;
      FV_DiscreteField_Vertex& operator=( 
      	FV_DiscreteField_Vertex const& other ) ;

      FV_DiscreteField_Vertex( MAC_Object* a_owner,
      ...
      FV_DiscreteField_Vertex( std::string const& a_type ) ;	
   ...
   //-- Attributes
      ...
      static FV_DiscreteField_Vertex const* PROTOTYPE ;
