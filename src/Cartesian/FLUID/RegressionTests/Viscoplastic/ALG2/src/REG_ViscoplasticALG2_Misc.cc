...
//---------------------------------------------------------------------------
void
REG_ViscoplasticALG2:: compute_strain_rate_tensor_D ( LA_Vector* VEC )
//---------------------------------------------------------------------------
{ 
   MAC_LABEL( "REG_ViscoplasticALG2:: compute_strain_rate_tensor_D" ) ;
...
//---------------------------------------------------------------------------
void
REG_ViscoplasticALG2:: update_strain_rate_tensor_d ( LA_Vector* VEC, 
	double const& alpha, double const& beta, 
	size_t const& first_field_level )
//---------------------------------------------------------------------------
{ 
   MAC_LABEL( "REG_ViscoplasticALG2:: update_strain_rate_tensor_d" ) ;
...
//---------------------------------------------------------------------------
double
REG_ViscoplasticALG2:: Compute_euclidian_norm (
		size_t i, size_t j, size_t comp,
		FV_SHIFT_TRIPLET shift, double const& beta, 
		size_t const& first_field_level )
//---------------------------------------------------------------------------
{ 
   MAC_LABEL( "REG_ViscoplasticALG2:: Compute_euclidian_norm" ) ;
...
//---------------------------------------------------------------------------
void
REG_ViscoplasticALG2:: update_Lagrange_multiplier ( LA_Vector* VEC )
//---------------------------------------------------------------------------
{ 
...
//---------------------------------------------------------------------------
double
REG_ViscoplasticALG2:: compute_norm_Dminusd ( )
//---------------------------------------------------------------------------
{ 
   MAC_LABEL( "REG_ViscoplasticALG2:: compute_norm_Dminusd" ) ;
