#ifndef REG_VISCOPLASTIC_ALG2_SYSTEM_HH
#define REG_VISCOPLASTIC_ALG2_SYSTEM_HH
...
class REG_ViscoplasticALG2System : public MAC_Object
{
   ...
   //-- Constructors & Destructor
      ...
      REG_ViscoplasticALG2System( void ) ;

      /** @brief Destructor */       
      virtual ~REG_ViscoplasticALG2System( void ) ;	

      /** @brief Copy constructor */       
      REG_ViscoplasticALG2System( REG_ViscoplasticALG2System const& other ) ;

      /** @brief Operator == 
      @param other the right hand side */   
      REG_ViscoplasticALG2System& operator=( 
      	REG_ViscoplasticALG2System const& other ) ;
      ...
      REG_ViscoplasticALG2System ( MAC_Object* a_owner,
   ...
   //-- Instance delivery and initialization
      ...
      @param b_pressure_rescaling_ rescale the pressure in case of all 
      	non-Dirichlet pressure BCs */
      static REG_ViscoplasticALG2System* create( MAC_Object* a_owner,
	MAC_ModuleExplorer const* exp,
        FV_DiscreteField* mac_uu,
        FV_DiscreteField* mac_pp,
	FV_DiscreteField* mac_dd,		
   ...
   //-- Attributes
      ...
      LA_Matrix * MAT_T_LagrangeMultiplierDivergence ;
