...
REG_ViscoplasticFISTASystem:: create( MAC_Object* a_owner,
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: create" ) ;
   MAC_CHECK_PRE( exp != 0 ) ;
   MAC_CHECK_PRE( mac_uu != 0 ) ;
   MAC_CHECK_PRE( mac_pp != 0 ) ;     

   REG_ViscoplasticFISTASystem* result = 
         new REG_ViscoplasticFISTASystem( a_owner, exp, mac_uu, mac_pp,
...
//----------------------------------------------------------------------
REG_ViscoplasticFISTASystem:: REG_ViscoplasticFISTASystem(
	MAC_Object* a_owner,
	MAC_ModuleExplorer const* exp,
	FV_DiscreteField* mac_uu,
	FV_DiscreteField* mac_pp,
...
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: REG_ViscoplasticFISTASystem" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: build_system( MAC_ModuleExplorer const* exp )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: build_system" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: re_initialize( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: re_initialize" ) ;
...
//----------------------------------------------------------------------
REG_ViscoplasticFISTASystem:: ~REG_ViscoplasticFISTASystem( void )
//----------------------------------------------------------------------
{}
...
//----------------------------------------------------------------------
double 
REG_ViscoplasticFISTASystem:: get_Stokes_convergence_criterion( void ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( 
     "REG_ViscoplasticFISTASystem:: get_Stokes_convergence_criterion" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::at_each_time_step( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: at_each_time_step" ) ;
...
//----------------------------------------------------------------------
double 
REG_ViscoplasticFISTASystem:: compute_velocity_change( void )
//----------------------------------------------------------------------
{ 	
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: compute_velocity_change" ) ;
...
//----------------------------------------------------------------------
double 
REG_ViscoplasticFISTASystem:: compute_velocity_change_iteration( void )
//----------------------------------------------------------------------
{ 	
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: compute_velocity_change_iteration" ) ;
...
//----------------------------------------------------------------------
double
REG_ViscoplasticFISTASystem:: compute_velocity_divergence_norm( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
   	"REG_ViscoplasticFISTASystem:: compute_velocity_divergence_norm" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::nullify_velocity_advection_rhs( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: nullify_velocity_advection_rhs" ) ;
...
//----------------------------------------------------------------------
bool 
REG_ViscoplasticFISTASystem:: Uzawa_solver( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: Uzawa_solver" ) ;   
...
//----------------------------------------------------------------------
bool 
REG_ViscoplasticFISTASystem:: PreconditionedStokes_Uzawa_solver( 
	const double &mupr, const double &gamma )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: Preconditioned_Uzawa_solver" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ViscoplasticFISTASystem:: get_solution_velocity( void ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: get_solution_U" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ViscoplasticFISTASystem:: get_solution_pressure( void ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: get_solution_P" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::initialize_velocity( void )
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::initialize_pressure( void )
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::initialize_tau_hat( size_t tau_hat_level )
//----------------------------------------------------------------------
{
   MAC_LABEL( "MAC_NavierStokesSystem:: initialize_tau_hat" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: finalize_constant_matrices( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: finalize_constant_matrices" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: compute_velocityAdvectionDiffusion_rhs( 
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: Uzawa_NavierStokes_solver( 
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_velocity_viscous_matrix_rhs( 
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_velocity_unsteady_matrix( 
	double const& coef )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_pdivv_matrix_rhs( double const& coef )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: assemble_pdivv_matrix_rhs" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_velocity_advection( 
	string const& AdvectionScheme,
      	size_t advecting_level, double const& coef, 
	size_t advected_level  )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: assemble_velocity_advection" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_pressure_laplacian_matrix_rhs( 
	double const& coef_lap )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
void 
REG_ViscoplasticFISTASystem:: pressure_laplacian_correction( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: pressure_laplacian_correction" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem:: assemble_tauGradv_tensor_divergence_matrix( 
	double const& coef )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: "
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::initialize_previous_iteration_velocity( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
     "REG_ViscoplasticFISTASystem:: initialize_previous_iteration_velocity" ) ;
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::compute_viscoplastic_TauhatMinus1overLd_vector( 
...
//----------------------------------------------------------------------
LA_Vector*
REG_ViscoplasticFISTASystem::get_tensor_unknown_vector( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: get_tensor_unknown_vector" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ViscoplasticFISTASystem:: get_solution_strainrate_tensor( void ) const
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
LA_Vector*
REG_ViscoplasticFISTASystem::get_TauhatMinus1overLd_vector( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: get_TauhatMinus1overLd_vector" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ViscoplasticFISTASystem:: get_solution_stress_tensor( void ) const
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
void
REG_ViscoplasticFISTASystem::add_storable_objects(
	MAC_ListIdentity* list ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ViscoplasticFISTASystem:: add_storable_objects" ) ; 
