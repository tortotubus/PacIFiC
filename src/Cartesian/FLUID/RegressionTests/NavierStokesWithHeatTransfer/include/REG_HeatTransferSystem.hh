...
/** @brief The Class REG_HeatTransferSystem.
...
class REG_HeatTransferSystem : public MAC_Object
{
   private: //----------------------------------------------------------
   ...
   //-- Constructors & Destructor
      ...
      REG_HeatTransferSystem( void ) ;

      /** @brief Destructor */       
      virtual ~REG_HeatTransferSystem( void ) ;	

      /** @brief Copy constructor */       
      REG_HeatTransferSystem( 
      	REG_HeatTransferSystem const& other ) ;

      /** @brief Operator == 
      @param other the right hand side */   
      REG_HeatTransferSystem& operator=( 
      	REG_HeatTransferSystem const& other ) ;
      ...
      @param HEAT_Advection_TimeAccuracy_ accuracy of the advection term time
      	discretization */      
      REG_HeatTransferSystem ( MAC_Object* a_owner,
   ...
   //-- Instance delivery and initialization
      ...
      @param HEAT_Advection_TimeAccuracy_ accuracy of the advection term time
      	discretization */
      static REG_HeatTransferSystem* create( MAC_Object* a_owner,
	MAC_ModuleExplorer const* exp,
        FV_DiscreteField* mac_tt,
        FV_DiscreteField const* mac_uu,
        size_t const& HEAT_Diffusion_TimeAccuracy_,	
   ...
   //-- Access
      ...
      /** @brief Return the source term vector */  
      LA_Vector* get_sourceTerm_vector( void ) ;                   
      //@}
   ...
   //-- Attributes
      ...
      LA_Vector * VEC_rhs_TemperatureSourceTerm ;      
