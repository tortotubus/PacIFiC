#ifndef REG_PROJ_NAVIER_STOKES_WITH_HEAT_TRANSFER_SYSTEM_HH
#define REG_PROJ_NAVIER_STOKES_WITH_HEAT_TRANSFER_SYSTEM_HH
...
/** @brief The Class REG_ProjNSWithHeatTransferSystem.

Generic matrix systems for the resolution of NavierStokes equations with
buoyancy. 

@author A. Wachs - Pacific project 2018-2019 */

class REG_ProjNSWithHeatTransferSystem : public MAC_Object
{
   private: //----------------------------------------------------------
   ...
   //-- Constructors & Destructor
      ...
      REG_ProjNSWithHeatTransferSystem( void ) ;

      /** @brief Destructor */       
      virtual ~REG_ProjNSWithHeatTransferSystem( void ) ;	

      /** @brief Copy constructor */       
      REG_ProjNSWithHeatTransferSystem( 
      	REG_ProjNSWithHeatTransferSystem const& other ) ;

      /** @brief Operator == 
      @param other the right hand side */   
      REG_ProjNSWithHeatTransferSystem& operator=( 
      	REG_ProjNSWithHeatTransferSystem const& other ) ;
      ...
      REG_ProjNSWithHeatTransferSystem ( MAC_Object* a_owner,
   ...
   //-- Instance delivery and initialization
      ...
      @param b_HighOrderPressureCorrection_ use high order pressure correction 
      @param b_with_buoyancy whether to add the buoyancy term to the rhs */
      static REG_ProjNSWithHeatTransferSystem* create( MAC_Object* a_owner,
	MAC_ModuleExplorer const* exp,
        FV_DiscreteField* mac_uu,
        FV_DiscreteField* mac_pp,
        size_t const& NS_Viscous_TimeAccuracy_,	
