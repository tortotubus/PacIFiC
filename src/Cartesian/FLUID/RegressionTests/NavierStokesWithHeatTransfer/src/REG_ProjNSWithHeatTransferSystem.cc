...
//----------------------------------------------------------------------
REG_ProjNSWithHeatTransferSystem*
REG_ProjNSWithHeatTransferSystem:: create( MAC_Object* a_owner,
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: create" ) ;
   MAC_CHECK_PRE( exp != 0 ) ;
   MAC_CHECK_PRE( mac_uu != 0 ) ;
   MAC_CHECK_PRE( mac_pp != 0 ) ;     

   REG_ProjNSWithHeatTransferSystem* result = 
         new REG_ProjNSWithHeatTransferSystem( a_owner, exp, mac_uu, mac_pp,
	 	NS_Viscous_TimeAccuracy_, NS_Advection_TimeAccuracy_,
		b_pressure_rescaling_, b_ExplicitPressureGradient_,
		b_HighOrderPressureCorrection_, b_with_buoyancy_ ) ;
...
//----------------------------------------------------------------------
REG_ProjNSWithHeatTransferSystem:: REG_ProjNSWithHeatTransferSystem(
	MAC_Object* a_owner,
	MAC_ModuleExplorer const* exp,
	FV_DiscreteField* mac_uu,
	FV_DiscreteField* mac_pp,
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: build_system( MAC_ModuleExplorer const* exp )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: build_system" ) ;
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: re_initialize( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: re_initialize" ) ;
...
//----------------------------------------------------------------------
REG_ProjNSWithHeatTransferSystem:: ~REG_ProjNSWithHeatTransferSystem( void )
//----------------------------------------------------------------------
{}
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::at_each_time_step( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: at_each_time_step" ) ;
...
//----------------------------------------------------------------------
double 
REG_ProjNSWithHeatTransferSystem:: compute_velocity_change( void )
//----------------------------------------------------------------------
{ 	
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: compute_velocity_change" ) ;
...
//----------------------------------------------------------------------
double
REG_ProjNSWithHeatTransferSystem:: compute_velocity_divergence_norm( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
     "REG_ProjNSWithHeatTransferSystem:: compute_velocity_divergence_norm" ) ;
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::nullify_velocity_advection_rhs( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
   	"REG_ProjNSWithHeatTransferSystem:: nullify_velocity_advection_rhs" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ProjNSWithHeatTransferSystem:: get_solution_velocity( void ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: get_solution_U" ) ;
...
//----------------------------------------------------------------------
LA_SeqVector const*
REG_ProjNSWithHeatTransferSystem:: get_solution_pressure( void ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: get_solution_P" ) ;
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::initialize_velocity( void )
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::initialize_pressure( void )
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: finalize_constant_matrices( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: compute_velocityAdvectionDiffusion_rhs( 
...
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: "
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: assemble_velocity_viscous_matrix_rhs( 
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: assemble_velocity_unsteady_matrix( 
	double const& coef )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: assemble_pdivv_matrix_rhs( 
	double const& coef )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: assemble_pdivv_matrix_rhs" ) ;
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: assemble_velocity_advection( 
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem:: assemble_pressure_laplacian_matrix_rhs( 
	double const& coef_lap )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
void 
REG_ProjNSWithHeatTransferSystem:: pressure_laplacian_correction( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( 
   	"REG_ProjNSWithHeatTransferSystem:: pressure_laplacian_correction" ) ;
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::add_storable_objects(
	MAC_ListIdentity* list ) const
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: add_storable_objects" ) ; 
...
//----------------------------------------------------------------------
bool
REG_ProjNSWithHeatTransferSystem::VelocityDiffusion_solver( void )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: VelocityDiffusion_solver" ) ;
...
//----------------------------------------------------------------------
double
REG_ProjNSWithHeatTransferSystem:: VelocityPressure_correction_solver( 
...
//----------------------------------------------------------------------
LA_Vector*
REG_ProjNSWithHeatTransferSystem::get_pressure_DirichletBC_vector(
	void ) 
//----------------------------------------------------------------------
{
   MAC_LABEL( 
...
//----------------------------------------------------------------------
LA_Vector*
REG_ProjNSWithHeatTransferSystem::get_unitary_periodic_pressure_drop_vector(
	void ) 
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: "
...
//----------------------------------------------------------------------
LA_Vector*
REG_ProjNSWithHeatTransferSystem::get_buoyancy_vector( void ) 
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: get_buoyancy_vector" ) ; 
...
//----------------------------------------------------------------------
void
REG_ProjNSWithHeatTransferSystem::store_ugradu_Nm2( 
	size_t const& n_advection_subtimesteps )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: store_ugradu_Nm2" ) ; 
...
//----------------------------------------------------------------------
bool
REG_ProjNSWithHeatTransferSystem:: VelocityAdvection_solver( void  )
//----------------------------------------------------------------------
{
   MAC_LABEL( "REG_ProjNSWithHeatTransferSystem:: VelocityAdvection_solver" ) ;
