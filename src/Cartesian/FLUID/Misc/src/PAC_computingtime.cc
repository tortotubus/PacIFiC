...
// ----------------------------------------------------------------------------
// Default constructor
PAC_ComputingTime::PAC_ComputingTime()
{}
...
PAC_ComputingTime::PAC_ComputingTime( string const& app_name_ )
{
...
// ----------------------------------------------------------------------------
// Copy constructor
PAC_ComputingTime::PAC_ComputingTime( PAC_ComputingTime const& CT )
{
  m_start = CT.m_start;
  m_end = CT.m_end;
...
// ----------------------------------------------------------------------------
// Set start 
void PAC_ComputingTime::CT_set_start()
{
...
double PAC_ComputingTime::CT_get_elapsed_time()
{
  double elapsed_time;
...
void PAC_ComputingTime::CT_add_elapsed_time()
{
  double elapsed_time;
...
string PAC_ComputingTime::CT_get_app_name() const
{
  return ( m_app_name );           
}
...
double PAC_ComputingTime::CT_get_total_elapsed_time() const
{
...
double PAC_ComputingTime::CT_get_mean_elapsed_time() const
{
...
int PAC_ComputingTime::CT_get_counter() const
{
  return ( m_counter );  
}
