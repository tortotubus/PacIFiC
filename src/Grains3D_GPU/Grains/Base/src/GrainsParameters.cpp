...
template <typename T>
bool GrainsParameters<T>::m_hasMovingObstacles = false;
...
template <typename T>
uint GrainsParameters<T>::m_cfKernelType = 0;
template <typename T>
...
template <typename T>
std::chrono::steady_clock::time_point GrainsParameters<T>::m_loopStart;
