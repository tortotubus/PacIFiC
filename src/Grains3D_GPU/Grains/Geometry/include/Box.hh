...
public:
    ...
    /** @brief Eroded box support: evaluates support of box with extents shrunk by crust */
    __HOSTDEVICE__
    ...
    /** @brief Returns box shape parameters: [Lx, Ly, Lz, 0, 0] */
    __HOSTDEVICE__
    ...
    /** @brief Writes the box as an OBJ mesh (see Convex::writeOBJ) */
    __HOST__
