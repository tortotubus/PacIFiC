...
public:
    ...
    /** @brief Atomically add quaternion components to this quaternion
        @param other quaternion whose components are added atomically */
    __DEVICE__
    void atomicAdd(const Quaternion<T>& other) noexcept;
    //@}
