...
public:
    ...
    /** @brief Eroded cone support: evaluates support of cone with shrunk dimensions */
    __HOSTDEVICE__
    ...
    /** @brief Returns cone shape parameters: [bottomRadius, height, 0, 0, 0] */
    __HOSTDEVICE__
    ...
    /** @brief Writes the cone as an OBJ mesh (see Convex::writeOBJ) */
    __HOST__
