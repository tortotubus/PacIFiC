...
public:
    ...
    /** @brief Returns the scalar value xxx of the attribute of a node "<root name="xxx">"
        @param root node
        @param name attribute name */
    static double getNodeAttr_Double(DOMNode* root, string const& name);

    /** @brief Returns the integer value xxx of the attribute of a node "<root name="xxx">"
        @param root node
        @param name attribute name */
    static int getNodeAttr_Int(DOMNode* root, string const& name);

    /** @brief Returns the string value xxx of the attribute of a node "<root name="xxx">"
        @param root node
        @param name attribute name */
    static string getNodeAttr_String(DOMNode* root, string const& name);

    /** @brief Returns whether the node root has an attribute named name "<node name="xxx">"
        @param root node
        @param name attribute name */
