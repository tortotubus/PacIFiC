...
export GRAINS_GPU_LINKER_FLAGS_RELEASE="-O3 -dlto \
    ...
    -use_fast_math -extra-device-vectorization -restrict \
    -ccbin ${_GCC940_BIN} \
    -L${NVHPC_BASE}/math_libs/12.2/targets/x86_64-linux/lib \
    -lcudart -lcudadevrt -lcurand \
    -lgomp \
...
export GRAINS_Z_INCDIR="/arc/software/spack-2024/opt/spack/linux-rocky9-skylake_avx512/gcc-11.4.1/zlib-ng-2.1.4-74bogisx4cwx76xmyfl73bgux5riny2s/include"
...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${NVHPC_BASE}/math_libs/12.2/targets/x86_64-linux/lib
# End LD_LIBRARY_PATH
