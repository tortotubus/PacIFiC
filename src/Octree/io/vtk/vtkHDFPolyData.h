...
typedef struct {
  ...
  hid_t grp_pointdata_offsets_id; /*!< Group id of
...
vtkHDFPolyData vtk_HDF_polydata_init_static(const char *fname, bool overwrite,
                                            vtkPolyData *vtk_pd);
vtkHDFPolyData vtk_HDF_polydata_init_transient(const char *fname,
                                               bool overwrite,
                                               vtkPolyData *vtk_pd, float time);
...
vtkHDFPolyData vtk_HDF_polydata_init_static(const char *fname, bool overwrite,
  ...
  vtkHDFPolyData vtk_hdf_pd = {
      ...
      .grp_pointdata_offsets_id =
          H5I_INVALID_HID /*!< PointData Offsets group */
  };
   ...
   */
  {
    ...
    vtk_HDF_write_attribute(attribute_name, attribute_data, attribute_datatype,
                            attribute_group, attribute_dims,
                            &vtk_hdf_pd.vtk_hdf);
  }
   ...
   */
  {
    ...
    hid_t attribute_group = vtk_hdf_pd.vtk_hdf.grp_vtkhdf_id;
    vtk_HDF_write_type_attribute(type_name, attribute_group,
                                 &vtk_hdf_pd.vtk_hdf);
  }
   ...
   */
  {
    ...
    MPI_Allreduce(&dataset_local_dims[0], &dataset_global_dims[0], 1,
   ...
   */
  {
    ...
    vtk_HDF_collective_write_dataset(dataset_name, &dataset_data,
                                     dataset_datatype, dataset_group, 1,
                                     dataset_global_dims, dataset_local_dims,
                                     dataset_offset, &vtk_hdf_pd.vtk_hdf);
   ...
   */
  {
#if _MPI
    int64_t connBase = 0;
    MPI_Exscan(&vtk_pd->n_lines_connectivity, &connBase, 1, MPI_INT64_T,
     ...
     */
    {
      ...
      MPI_Exscan(&vtk_pd->n_lines_offsets, &offwriteBase, 1, MPI_INT64_T,
                 MPI_SUM, MPI_COMM_WORLD);
      if (pid() == 0)
        offwriteBase = 0;
   ...
   */
  {
#if _MPI
    int64_t connBase = 0;
    MPI_Exscan(&vtk_pd->n_polygons_connectivity, &connBase, 1, MPI_INT64_T,
               MPI_SUM, MPI_COMM_WORLD);
    if (pid() == 0)
      connBase = 0;
#endif
     ...
     */
    {
      ...
      int64_t offwriteBase = 0;
      MPI_Exscan(&vtk_pd->n_polygons_offsets, &offwriteBase, 1, MPI_INT64_T,
                 MPI_SUM, MPI_COMM_WORLD);
      if (pid() == 0)
        offwriteBase = 0;
      hsize_t dataset_offset[] = {(hsize_t)offwriteBase};
   ...
   */
  {
...
#if _MPI
    int64_t connBase = 0;
    MPI_Exscan(&vtk_pd->n_strips_connectivity, &connBase, 1, MPI_INT64_T,
               MPI_SUM, MPI_COMM_WORLD);
    if (pid() == 0)
      connBase = 0;
#endif
     ...
     */
    {
      ...
      int64_t offwriteBase = 0;
      MPI_Exscan(&vtk_pd->n_strips_offsets, &offwriteBase, 1, MPI_INT64_T,
                 MPI_SUM, MPI_COMM_WORLD);
      if (pid() == 0)
        offwriteBase = 0;
      hsize_t dataset_offset[] = {(hsize_t)offwriteBase};
   ...
   */
  {
#if _MPI
    int64_t connBase = 0;
    MPI_Exscan(&vtk_pd->n_vertices_connectivity, &connBase, 1, MPI_INT64_T,
               MPI_SUM, MPI_COMM_WORLD);
    if (pid() == 0)
      connBase = 0;
#endif
     ...
     */
    {
      ...
      int64_t offwriteBase = 0;
      MPI_Exscan(&vtk_pd->n_vertices_offsets, &offwriteBase, 1, MPI_INT64_T,
                 MPI_SUM, MPI_COMM_WORLD);
      if (pid() == 0)
        offwriteBase = 0;
      hsize_t dataset_offset[] = {(hsize_t)offwriteBase};
...
vtkHDFPolyData vtk_HDF_polydata_init_transient(const char *fname,
   ...
   */
  {
    ...
    vtk_HDF_write_chunked_dataset(dataset_name, dataset_data, dataset_datatype,
                                  dataset_group, 2, dataset_dims,
                                  dataset_max_dims, dataset_chunk_dims,
                                  &vtk_hdf_pd.vtk_hdf);
  }
   ...
   */
  {
     ...
     */
    {
      ...
      vtk_HDF_write_chunked_dataset(dataset_name, dataset_data,
                                    dataset_datatype, dataset_group, 1,
                                    dataset_dims, dataset_max_dims,
                                    dataset_chunk_dims, &vtk_hdf_pd.vtk_hdf);
    }
   ...
   */
  {
     ...
     */
    {
      ...
      vtk_HDF_write_scalar_attribute(attribute_name, &attribute_data,
                                     attribute_datatype, attribute_group,
                                     &vtk_hdf_pd.vtk_hdf);
    }
     ...
     */
    {
      ...
      vtk_HDF_write_chunked_dataset(dataset_name, dataset_data,
                                    dataset_datatype, dataset_group, 2,
                                    dataset_dims, dataset_max_dims,
                                    dataset_chunk_dims, &vtk_hdf_pd.vtk_hdf);
    }
...
vtkHDFPolyData vtk_HDF_polydata_append_transient(const char *fname,
  ...
  vtk_hdf_pd.grp_celldata_id = H5Gopen2(vtk_hdf_pd.vtk_hdf.grp_vtkhdf_id,
                                        "/VTKHDF/CellData", H5P_DEFAULT);

  vtk_HDF_check_object(&vtk_hdf_pd.vtk_hdf, vtk_hdf_pd.grp_celldata_id);

  vtk_hdf_pd.grp_pointdata_id = H5Gopen2(vtk_hdf_pd.vtk_hdf.grp_vtkhdf_id,
                                         "/VTKHDF/PointData", H5P_DEFAULT);

  vtk_HDF_check_object(&vtk_hdf_pd.vtk_hdf, vtk_hdf_pd.grp_pointdata_id);

  vtk_hdf_pd.grp_vertices_id = H5Gopen2(vtk_hdf_pd.vtk_hdf.grp_vtkhdf_id,
                                        "/VTKHDF/Vertices", H5P_DEFAULT);
  vtk_HDF_check_object(&vtk_hdf_pd.vtk_hdf, vtk_hdf_pd.grp_vertices_id);
  ...
  vtk_hdf_pd.grp_polygons_id = H5Gopen2(vtk_hdf_pd.vtk_hdf.grp_vtkhdf_id,
                                        "/VTKHDF/Polygons", H5P_DEFAULT);
   ...
   */
  {
     ...
     */
    {
      ...
      vtk_HDF_read_scalar_attribute(attribute_name, &attribute_data,
                                    attribute_group, &vtk_hdf_pd.vtk_hdf);

      attribute_data++;

      vtk_HDF_modify_scalar_attribute(attribute_name, &attribute_data,
                                      attribute_datatype, attribute_group,
                                      &vtk_hdf_pd.vtk_hdf);
    }
     ...
     */
    {
      ...
      vtk_HDF_append_chunked_dataset(dataset_name, dataset_data,
                                     dataset_datatype, dataset_group, 2,
                                     dataset_dims, &vtk_hdf_pd.vtk_hdf);
    }
     ...
     */
    {
      ...
      vtk_HDF_read_dataset(dataset_name, (void **)&dataset_data_previous,
                           dataset_datatype, dataset_group, 1,
                           dataset_dims_prev, dataset_max_dims_prev,
                           &vtk_hdf_pd.vtk_hdf);
     ...
     */
    {
      ...
      vtk_HDF_read_dataset(read_dataset_name, (void **)&read_dataset_data,
                           read_dataset_datatype, read_dataset_group, 1,
                           read_dataset_dims, read_dataset_max_dims,
                           &vtk_hdf_pd.vtk_hdf);
      ...
      vtk_HDF_append_chunked_dataset(
          write_dataset_name, write_dataset_data, write_dataset_datatype,
          write_dataset_group, 1, write_dataset_dims, &vtk_hdf_pd.vtk_hdf);
    }
   ...
   */
  {
    ...
    vtk_HDF_append_chunked_dataset(dataset_name, dataset_data, dataset_datatype,
                                   dataset_group, 2, dataset_dims,
                                   &vtk_hdf_pd.vtk_hdf);
  }
