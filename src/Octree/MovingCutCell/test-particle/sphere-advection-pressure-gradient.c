...
[cylinder-advection-pressure-gradient.c](). In this test case, the
sphere is twice as heavy as the fluid and is advected in the
xz-direction by a pressure gradient.
