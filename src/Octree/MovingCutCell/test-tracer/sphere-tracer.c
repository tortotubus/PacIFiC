/**
# Flow past a fixed sphere at different Reynolds number and Peclet numbers $Pe$

This test case is the fixed embedded boundary analog of the [flow past
a sphere at $Re=300$](/src/examples/sphere.c).
...
![Vorticity](sphere-tracer/vorticity.mp4)(loop)

![Tracer field](sphere-tracer/scalar.mp4)(loop)
...
set xlabel 'z/d'
set xrange [-10:10]
plot '< cat fields-z-1-pid-*'  u 1:2 w l lw 2 lc rgb "blue"      t 't=1', \
...
set xlabel 'z/d'
set ylabel 'gf.z'
plot '< cat fields-z-1-pid-*'  u 1:3 w l lw 2 lc rgb "blue"      t 't=1', \
