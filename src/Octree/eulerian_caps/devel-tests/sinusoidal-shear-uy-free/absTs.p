...
plot 'out' every ::1 using 1:28 axis x1y1 w l ls 1 title '|T_{s, xx}|_{avg}', \
'out' every ::1 u 1:30 axis x1y1 w l ls 2 title '|T_{s, yy}|_{avg}', \
'out' every ::1 u 1:29 axis x1y1 w l ls 3 title '|T_{s, xy}|_{avg}'
