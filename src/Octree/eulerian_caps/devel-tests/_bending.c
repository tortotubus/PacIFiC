...
#line 41 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
scalar caps= {12};
...
#line 33 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) val(q_prev,0,0,0) = HUGE;
  } } end_foreach(); }
  int k = 0;
...
#line 43 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10)) {
        double conv = fabs(val(q,0,0,0) - val(q_prev,0,0,0));
...
#line 53 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
...
#line 55
 {
          val(q,0,0,0) -= dtau*(max(-sign(val(f,0,0,0))*val(extended_n.y,0,0,0), 0.)*(val(q_prev,0,0,0)
                - val(q_prev,0,-1,0)) + min(-sign(val(f,0,0,0))*val(extended_n.y,0,0,0), 0.)*(val(q_prev,0,1,0)
                - val(q_prev,0,0,0)))/Delta;
        }}
      }
    } } end_foreach(); }
    boundary(((scalar []){q,{-1}}));
    k++;
#line 93 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
  }
  if (k == (1.e+3))
    fprintf(ferr, "WARNING: maximum iterations reached in normal_scalar_extension\n");
  fprintf(ferr, "k=%d\n",k);
 delete (((scalar []){q_prev,{-1}})); }
...
#line 106 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) {
      if ((interfacial(point, f))) {
...
#line 115
 {
  ...
  boundary((scalar *)((vector []){{normals.x,normals.y},{{-1},{-1}}}));
 { if (!(fh).x.i) delete (((scalar []){h.x,h.y,{-1}})); } }
...
#line 124 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
...
#line 142 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10)) {
        double conv = 0;
        {
#line 145
 {
          conv += sqrt(sq(val(qv.x,0,0,0) - val(qv_prev.x,0,0,0)));
          val(qv_prev.x,0,0,0) = val(qv.x,0,0,0);
        }
#line 145
 {
          conv += sqrt(sq(val(qv.y,0,0,0) - val(qv_prev.y,0,0,0)));
...
#line 155 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10) && !((interfacial(point, f)))) {
        {
#line 157
...
#line 157
 ...
 delete (((scalar []){qv_prev.x,qv_prev.y,{-1}})); }
...
static int defaults_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_2 (const int i, const double t, Event * _ev) { trace ("defaults_2", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 54);  {
  for (scalar s = *((scalar []){extended_n.x,extended_n.y,T_s.x.x,T_s.x.y,T_s.y.x,T_s.y.y,{-1}}), *_i61 = ((scalar []){extended_n.x,extended_n.y,T_s.x.x,T_s.x.y,T_s.y.x,T_s.y.y,{-1}}); ((scalar *)&s)->i >= 0; s = *++_i61) {
      _attribute[s.i].v.x.i = -1;
  }
   { foreach(){
...
#line 113 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) {
      {
#line 115
...
#line 124
 {
        val(T_s.x.x,0,0,0) = 0.;
        val(T_s.x.y,0,0,0) = 0.;
        val(extended_n.x,0,0,0) = 0.;
      }
#line 124
 {
        val(T_s.y.y,0,0,0) = 0.;
        val(T_s.y.x,0,0,0) = 0.;
        val(extended_n.y,0,0,0) = 0.;
      }}
    }
  } } end_foreach(); }
  boundary(((scalar []){T_s.x.x,T_s.x.y,T_s.y.x,T_s.y.y,extended_n.x,extended_n.y,{-1}}));
...
#line 1 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
#line 11 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
...
static int stability_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_1 (const int i, const double t, Event * _ev) { trace ("stability_1", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 18);  {
...
#line 20 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
 {
...
#line 24
  ...
  double dt = .0005*sqrt (rhom*cube(dmin)/(pi*(1.*4.*1./0.00125)));
  if (dt < dtmax)
  dtmax = dt;
 end_trace("stability_1", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 29); } return 0; } 
...
#line 33 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"

    if (((val(ngcaps,-1,0,0) > 1.e-10)) && ((val(ngcaps,1,0,0) > 1.e-10))) return ((val(s,1,0,0) - val(s,-1,0,0))/(2.*Delta));
    else if (((val(ngcaps,1,0,0) > 1.e-10))) {
...
#line 33 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
    ...
    if (((val(ngcaps,0,-1,0) > 1.e-10)) && ((val(ngcaps,0,1,0) > 1.e-10))) return ((val(s,0,1,0) - val(s,0,-1,0))/(2.*Delta));
    else if (((val(ngcaps,0,1,0) > 1.e-10))) {
...
tensor m_bend= {{{37},{38}},{{39},{40}}};
vector q_bend= {{41},{42}};

static int acceleration_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_1 (const int i, const double t, Event * _ev) { trace ("acceleration_1", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 47); 
{
   { foreach(){

#line 49 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) {
...
#line 52
 {
        val(m_bend.x.x,0,0,0) = (1.*4.*1./0.00125)*my_gradient_x(point, extended_n.x);
        val(m_bend.x.y,0,0,0) = (1.*4.*1./0.00125)*my_gradient_y(point, extended_n.x);
      }
#line 52
 {
        val(m_bend.y.y,0,0,0) = (1.*4.*1./0.00125)*my_gradient_y(point, extended_n.y);
        val(m_bend.y.x,0,0,0) = (1.*4.*1./0.00125)*my_gradient_x(point, extended_n.y);
      }}
    }
  } } end_foreach(); }
...
#line 59 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
 {
    pseudo_v sdiv_m;
...
#line 78 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10))
    {
      {
...
#line 81
 ...
 end_trace("acceleration_1", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 89); } return 0; } 
#line 23 "bending.c"
#line 1 "view.h"
...
static int init_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t=0);   *ip = i; *tp = t;   return ret; } static int init_1 (const int i, const double t, Event * _ev) { trace ("init_1", "bending.c", 51);  {
...
#line 52 "bending.c"
 ...
 end_trace("init_1", "bending.c", 53); } return 0; } 

static int movie_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i += 100);   *ip = i; *tp = t;   return ret; } static int movie (const int i, const double t, Event * _ev) { trace ("movie", "bending.c", 55);  {
  ...
  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"T_s.x.x", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"Tsxx.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"T_s.x.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"Tsxy.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"T_s.y.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"Tsyy.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"m_bend.x.x", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"mxx.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"m_bend.x.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"mxy.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"m_bend.y.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"myy.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"q_bend.x", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"qx.mp4"});

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"q_bend.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  save ((struct _save){"qy.mp4"});
 ...
 end_trace("movie", "bending.c", 160); } return 0; } 

static int end_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = (10./1.));   *ip = i; *tp = t;   return ret; } static int end (const int i, const double t, Event * _ev) { trace ("end", "bending.c", 162);  {
  { int _ret =  1.; end_trace("end", "bending.c", 163);  return _ret; }
 end_trace("end", "bending.c", 164); } return 0; } 
#line 91 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/navier-stokes/my_centered.h"
...
#line 47 "bending.c"
return  dirichlet((t < (1./1.) ? 1.*y : 0.)); return 0.; } static double _boundary6_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 47 "bending.c"
return  dirichlet_homogeneous(); return 0.; }
#line 49 "bending.c"
...
#line 48 "bending.c"
return  dirichlet((t < (1./1.) ? 1.*y : 0.)); return 0.; } static double _boundary7_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 48 "bending.c"
return  dirichlet_homogeneous(); return 0.; }
size_t datasize = 44*sizeof (double);
...
void _init_solver (void) {
  ...
  event_register ((Event){ 0, 1, stability_1, {stability_1_expr0}, ((int *)0), ((double *)0),
    "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 18, "stability"});
  ...
  event_register ((Event){ 0, 1, acceleration_1, {acceleration_1_expr0}, ((int *)0), ((double *)0),
    "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/bending_2D.h", 47, "acceleration"});
  ...
  all = (scalar *) pmalloc (sizeof (scalar)*45,__func__, __FILE__, __LINE__);
  for (int i = 0; i < 44; i++)
    all[i].i = i;
  all[44].i = -1;
  set_fpe();
  multigrid_methods();
  init_scalar ((scalar){43}, "sdivu");
  init_vector ((vector){{41},{42}}, "q_bend");
  init_tensor ((tensor){{{37},{38}},{{39},{40}}}, "m_bend");
