...
'../scalar_extension_2/out' every ::3 using 2:4 axis x1y1 w l ls 3 title "L_2-error, coarse normals", \
'../scalar_extension_2/out' every ::3 using 2:5 axis x1y2 w l ls 4 title "L_{max}-error, coarse normals"
