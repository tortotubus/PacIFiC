#line 1 "normals_extension-cpp.c"
#line 1 "<built-in>"
#line 1 "<command-line>"
...
#line 14 "normals_extension-cpp.c"
...
#line 36 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
scalar caps= {15};
...
static int defaults_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_2 (const int i, const double t, Event * _ev) { trace ("defaults_2", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 44);  {
  {
#line 45
 {
...
#line 45
 ...
 end_trace("defaults_2", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 59); } return 0; } 

static int pp_vof_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int pp_vof_0 (const int i, const double t, Event * _ev) { trace ("pp_vof_0", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 61);  {
  boundary(((scalar []){f,caps,ngcaps,grad_caps.x,grad_caps.y,{-1}}));
     { foreach(){

#line 63 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
 {
...
#line 74 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
 {
...
#line 84 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
 {
    {
#line 85
 {
...
#line 85
 ...
 end_trace("pp_vof_0", "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 93); } return 0; } 
#line 15 "normals_extension.c"
...
#line 16 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
#line 1 "./curvature.h"
...
#line 17 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"


void normal_scalar_extension(scalar q) {
  double dtau = .25/(pow(2,7));
  scalar q_prev= new_scalar("q_prev"), convergence= new_scalar("convergence");
  int i = 0;

  while (((normf(convergence).max > 1.e-6) || i == 0) && (i < 1.e+3)) {
     { foreach(){

#line 25 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {

        val(convergence,0,0,0) = fabs(val(q,0,0,0) - val(q_prev,0,0,0));
...
#line 33 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10) && !((fabs(val(f,1,0,0) - val(f,0,0,0)) > .5) || (fabs(val(f,-1,0,0) - val(f,0,0,0)) > .5) || (fabs(val(f,0,1,0) - val(f,0,0,0)) > .5) || (fabs(val(f,0,-1,0) - val(f,0,0,0)) > .5))) {
        {
#line 35
 {
          val(q,0,0,0) -= dtau*(max(-sign(val(f,0,0,0))*val(extended_n.x,0,0,0), 0.)*(val(q_prev,0,0,0) - val(q_prev,-1,0,0))
                + min(-sign(val(f,0,0,0))*val(extended_n.x,0,0,0), 0.)*(val(q_prev,1,0,0) - val(q_prev,0,0,0)))/Delta;
        }
#line 35
 {
          val(q,0,0,0) -= dtau*(max(-sign(val(f,0,0,0))*val(extended_n.y,0,0,0), 0.)*(val(q_prev,0,0,0) - val(q_prev,0,-1,0))
                + min(-sign(val(f,0,0,0))*val(extended_n.y,0,0,0), 0.)*(val(q_prev,0,1,0) - val(q_prev,0,0,0)))/Delta;
        }}
    ...
    i++;
#line 70 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
  }
 delete (((scalar []){convergence,q_prev,{-1}})); }

void initialize_normals_for_extension(vector normals) {
  vector n= new_vector("n");
  coord n_coord, A, P, Q, ni, nj;
...
#line 85 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
    if ((interfacial(point, f))) {
...
#line 94 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
    if ((interfacial(point, f))) {
      int c = 0;
      double intercept = 0., area = 0., theta1 = 0., theta2 = 0.;
      coord n_avg = {0., 0., 0.};
      coord center = {x, y, z};

      {
#line 101
 ni.x = val(normals.x,0,0,0);
#line 101
 ni.y = val(normals.y,0,0,0);}
      if (fabs(ni.y) > 1.e-4) {
        intercept = line_alpha(val(f,0,0,0), ni);
        area = line_length_center(ni,intercept,&P);
        {
#line 105
 P.x = x + Delta*P.x;
#line 105
        ...
        printf("---\nni.x=%g, ni.y=%g, a=%g\n", ni.x, ni.y, a);
         ...
         { foreach_neighbor(1) {
          if ((interfacial(point, f))) {
            {
#line 112
 nj.x = val(normals.x,0,0,0);
#line 112
 nj.y = val(normals.y,0,0,0);}
            intercept = line_alpha(val(f,0,0,0), nj);
            printf("ni.x=%g, ni.y=%g, nj.x=%g, nj.y=%g, my_a=%g\n",ni.x, ni.y, nj.x, nj.y, a);
            theta1 = acos(clamp(ni.x*nj.x + ni.y*nj.y,-1,1));
            area = line_length_center(nj,intercept,&Q);
            {
#line 117
 Q.x = x + Delta*Q.x;
#line 117
...
#line 123
 n_avg.y += ni.y;}
                ...
                A.x = (a*P.x - b*Q.x + Q.y - P.y)/(a - b);
                A.y = P.y + (b*(P.x - Q.x) + Q.y - P.y)*a/(a - b);
                coord v = {(center.x - A.x), (center.y - A.y), 0.};
                double normv = sqrt(sq(v.x) + sq(v.y));
                {
#line 130
 v.x /= normv;
#line 130
 v.y /= normv;}
                theta2 = acos(clamp(v.x*ni.x + v.y*ni.y,-1,1));
                printf("theta1=%g, theta2=%g\n",theta1, theta2);
                double d = theta2/theta1;
                {
#line 134
 n_avg.x += d*ni.x + (1 - d)*nj.x;
#line 134
 n_avg.y += d*ni.y + (1 - d)*nj.y;}
              }
            }
          }
        } end_foreach_neighbor(); }
        {
#line 139
 val(normals.x,0,0,0) = n_avg.x/c;
#line 139
 val(normals.y,0,0,0) = n_avg.y/c;}
        normn = sqrt(sq(val(normals.x,0,0,0)) + sq(val(normals.y,0,0,0)));
        {
#line 141
 val(normals.x,0,0,0) = val(normals.x,0,0,0)/normn;
#line 141
 val(normals.y,0,0,0) = val(normals.y,0,0,0)/normn;}
      }
    }
  } } end_foreach(); }
 delete (((scalar []){alpha,n.x,n.y,{-1}}));  { if (!(fh).x.i) delete (((scalar []){h.x,h.y,{-1}})); } }
...
#line 147 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
...
void normal_vector_extension(vector qv) {
  double dtau = .25/(pow(2,7));
  scalar convergence= new_scalar("convergence");
  vector qv_prev= new_vector("qv_prev");
  int i = 0;
  while (((normf(convergence).max > 1.e-6) || i == 0) && (i < 1.e+3)) {
     { foreach(){

#line 163 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10)) {
      val(convergence,0,0,0) = 0.;
        {
#line 166
 {
          val(convergence,0,0,0) += sq(val(qv.x,0,0,0) - val(qv_prev.x,0,0,0));
          val(qv_prev.x,0,0,0) = val(qv.x,0,0,0);
        }
#line 166
 {
          val(convergence,0,0,0) += sq(val(qv.y,0,0,0) - val(qv_prev.y,0,0,0));
          val(qv_prev.y,0,0,0) = val(qv.y,0,0,0);
        }}
        val(convergence,0,0,0) = sqrt(val(convergence,0,0,0));
      }
    } } end_foreach(); }
     { foreach(){

#line 173 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/normal_extension.h"
 {
      if ((val(ngcaps,0,0,0) > 1.e-10) && !((interfacial(point, f)))) {
        {
#line 175
 {
...
#line 175
 ...
 delete (((scalar []){qv_prev.x,qv_prev.y,convergence,{-1}})); }
#line 16 "normals_extension.c"
#line 1 "view.h"
...
{ trace ("input_gfs", "/home/damien/phd/pacific/Octree/basilisk/src/input.h", 168);
  ...
  while (s1) {
    ...
    bool found = false;
    if (p.list) for (scalar s = *p.list, *_i61 = p.list; ((scalar *)&s)->i >= 0; s = *++_i61)
...
#line 273 "/home/damien/phd/pacific/Octree/basilisk/src/input.h"
 {
    ...
    if (input) for (scalar s = *input, *_i62 = input; ((scalar *)&s)->i >= 0; s = *++_i62) {
...
static void _set_boundary17 (void) { _attribute[u.x.i].boundary[top] = _boundary17; _attribute[u.x.i].boundary_homogeneous[top] = _boundary17_homogeneous; } 
static void _set_boundary18 (void) { _attribute[u.x.i].boundary[left] = _boundary18; _attribute[u.x.i].boundary_homogeneous[left] = _boundary18_homogeneous; } 
static void _set_boundary19 (void) { _attribute[u.x.i].boundary[right] = _boundary19; _attribute[u.x.i].boundary_homogeneous[right] = _boundary19_homogeneous; } 

static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "normals_extension.c", 42);  {
  do { scalar phi= new_vertex_scalar("phi");  { foreach_vertex(){

#line 43 "normals_extension.c"
 ...
 end_trace("init_0", "normals_extension.c", 44); } return 0; } 

static int extension_event_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int extension_event (const int i, const double t, Event * _ev) { trace ("extension_event", "normals_extension.c", 46);  {
   { foreach(){

#line 47 "normals_extension.c"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) {
 ...
 end_trace("extension_event", "normals_extension.c", 65); } return 0; } 

scalar error_normals= {23};
static int output_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int output (const int i, const double t, Event * _ev) { trace ("output", "normals_extension.c", 68);  {
   { foreach(){

#line 69 "normals_extension.c"
 {
    if ((val(ngcaps,0,0,0) > 1.e-10)) {
      double my_alpha;
      if (fabs(x)>0.) my_alpha = atan2(y,x);
      else my_alpha = y > 0 ? pi/2 : -pi/2;
      val(error_normals,0,0,0) = sq(val(extended_n.x,0,0,0) - cos(my_alpha));
      val(error_normals,0,0,0) += sq(val(extended_n.y,0,0,0) - sin(my_alpha));
      val(error_normals,0,0,0) = sqrt(val(error_normals,0,0,0));
    }
    else {
      {
#line 79
 val(error_normals,0,0,0) = 0.;
#line 79
 val(error_normals,0,0,0) = 0.;}
    }
  } } end_foreach(); }
  ...
  fprintf(fout, "%g %g %g\n", t, normf(error_normals).avg, normf(error_normals).max);
 end_trace("output", "normals_extension.c", 87); } return 0; } 

static int picture_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int picture (const int i, const double t, Event * _ev) { trace ("picture", "normals_extension.c", 89);  {
  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"extended_n.x", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  if (i == 1) {
    save ((struct _save){"nx_init.png"});
  }
  else if (i == 2) {
    save ((struct _save){"nx_extended.png"});
  }
  else if (i == 3) {
    save ((struct _save){"nx_exact.png"});
  }

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});
  cells ((struct _cells){0});
  squares ((struct _squares){"extended_n.y", .linear = false});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  if (i == 1) {
    save ((struct _save){"ny_init.png"});
  }
  else if (i == 2) {
    save ((struct _save){"ny_extended.png"});
  }
  else if (i == 3) {
    save ((struct _save){"ny_exact.png"});
  }

  view ((struct _view_set){.fov = 20, .camera = "front", .bg = {1,1,1}});

  squares ((struct _squares){"error_normals", .linear = false, .min = 0., .max = error_max});
  draw_vof ((struct _draw_vof){"f", .lw = 2});
  box ((struct _box){.notics = true});
  if (i == 1) {
    save ((struct _save){"error_init.png"});
  }
  else if (i == 2) {
    save ((struct _save){"error_extended.png"});
  }
 end_trace("picture", "normals_extension.c", 131); } return 0; } 

static int end_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 3);   *ip = i; *tp = t;   return ret; } static int end (const int i, const double t, Event * _ev) { trace ("end", "normals_extension.c", 133);  {
  { int _ret =  1.; end_trace("end", "normals_extension.c", 134);  return _ret; }
 end_trace("end", "normals_extension.c", 135); } return 0; } 
#line 91 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/navier-stokes/my_centered.h"
...
#line 102
return  neumann_homogeneous(); } return 0.; }
#line 46 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 45 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 45 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 47 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 46 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 48 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 47 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 49 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 48 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 50 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 49 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 51 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 51 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 53 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 52 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 54 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 53 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 55 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 54 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 56 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 55 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
return  neumann_homogeneous(); return 0.; }
#line 57 "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h"
...
#line 37 "normals_extension.c"
return  dirichlet(0); return 0.; } static double _boundary17_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 37 "normals_extension.c"
return  dirichlet_homogeneous(); return 0.; }
#line 39 "normals_extension.c"
...
static int output (const int i, const double t, Event * _ev);
static int output_expr0 (int * ip, double * tp, Event * _ev);
...
void _init_solver (void) {
  ...
  event_register ((Event){ 0, 1, defaults_2, {defaults_2_expr0}, ((int *)0), ((double *)0),
    "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 44, "defaults"});
  ...
  event_register ((Event){ 0, 1, init_0, {init_0_expr0}, ((int *)0), ((double *)0),
    "normals_extension.c", 42, "init"});
  event_register ((Event){ 0, 1, extension_event, {extension_event_expr0}, ((int *)0), ((double *)0),
    "normals_extension.c", 46, "extension_event"});
  event_register ((Event){ 0, 1, output, {output_expr0}, ((int *)0), ((double *)0),
    "normals_extension.c", 68, "output"});
  event_register ((Event){ 0, 1, picture, {picture_expr0}, ((int *)0), ((double *)0),
    "normals_extension.c", 89, "picture"});
  event_register ((Event){ 0, 1, end, {end_expr0}, ((int *)0), ((double *)0),
    "normals_extension.c", 133, "end"});
  ...
  event_register ((Event){ 0, 1, pp_vof_0, {pp_vof_0_expr0}, ((int *)0), ((double *)0),
    "/home/damien/phd/pacific/Octree/basilisk/src/eulerian_caps/capsule.h", 61, "pp_vof"});
  ...
  set_fpe();
  multigrid_methods();
  init_scalar ((scalar){23}, "error_normals");
  ...
  init_scalar ((scalar){2}, "q");
  init_vector ((vector){{0},{1}}, "extended_n");
