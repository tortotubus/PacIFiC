#ifndef _DS_3DSPHEROIDCYLINDER__
#define _DS_3DSPHEROIDCYLINDER__
...
/** @brief The class DS_3Dspheroidcylinder.
...
class DS_3Dspheroidcylinder: public DS_RigidBody
{
   public: //-----------------------------------------------------------------
   ...
   //-- Constructors & Destructor
      ...
      @param copy copied DS_3Dspheroidcylinder object */
      DS_3Dspheroidcylinder( DS_3Dspheroidcylinder const& copy );
      //@}
};
