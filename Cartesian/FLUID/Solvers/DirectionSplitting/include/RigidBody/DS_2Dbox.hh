...
/** @brief The class DS_2Dbox.

A moving or stationary rigid 2D box of axisymmetric cross-section in the
Direction Splitting solver.

@author A. Wachs - Pacific project 2021 */

class DS_2Dbox: public DS_RigidBody
{
   public: //-----------------------------------------------------------------
   ...
   //-- Methods
      ...
      /** @brief Computes the min and max extents of the 2D cylinder halozone
      , required for the computation of void fraction */
      void compute_rigid_body_halozone( double const& dx );

      /** @brief Compute the surface points by discretizing the 2D cylinder
      ...
      /** @brief Compute number of points on a 2D cylinder
   ...
   //-- Constructors & Destructor
      ...
      @param copy copied DS_2Dbox object */
      DS_2Dbox( DS_2Dbox const& copy );
      //@}
};
