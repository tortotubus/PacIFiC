...
//---------------------------------------------------------------------------
{
    ...
    DLMFD_DirectionSplitting_bis *result =
        new DLMFD_DirectionSplitting_bis(a_owner, dom, exp);
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: do_after_time_stepping");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: add_storable_objects");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: ugradu_initialization");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: NS_first_step");
...
// //---------------------------------------------------------------------------
// double
// DLMFD_DirectionSplitting_bis::compute_un_component_FV(size_t const &comp,
//                                                   size_t const &i,
//                                                   size_t const &j,
//                                                   size_t const &k,
//                                                   size_t const &dir,
...
// //---------------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting_bis:: compute_un_component_FV");
...
//---------------------------------------------------------------------------
{
    ...
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: velocity_local_rhs");
...
//---------------------------------------------------------------------------
{
    ...
    double per_vel = -t_it->time_step() / (rho * periodic_length);
...
//---------------------------------------------------------------------------
{
    ...
    // DLMFD explicit
    size_t local_numbering_index = 0;
    double dlmfd_explicit_value = 0.;

    LA_SeqVector const *VEC_rhs_VelocityDLMFD_Nm1_local = NULL;
    if (b_ExplicitDLMFD)
        VEC_rhs_VelocityDLMFD_Nm1_local = GLOBAL_EQ->get_rhs_DLMFD_Nm1();
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting_bis::correct_mean_pressure(size_t const &level)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: correct_mean_pressure");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: NS_final_step");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: create_DS_subcommunicators");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: set_translation_vector");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: build_links_translation");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: compute_outOfDomain_Pressure");
...
//---------------------------------------------------------------------------
{
    ...
    // Velocity Translation-Projection
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting_bis:: synchronize_DLMFD_Nm1_rhs");
