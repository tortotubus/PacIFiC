...
//----------------------------------------------------------------------
void DLMFD_ProjectionNavierStokesSystem::build_system(MAC_ModuleExplorer const *exp)
//----------------------------------------------------------------------
{
...
//----------------------------------------------------------------------
{
   ...
   if (MAC_Exec::communicator()->rank() == 0)
      MAC::out() << "Nb iterations = " << SOLVER_A_VelocityUnsteadyPlusViscous->nb_iterations_achieved()
                 << endl;
...
//----------------------------------------------------------------------
{
   ...
   if (MAC_Exec::communicator()->rank() == 0)
      MAC::out() << "Nb iterations sub-linear systems = " << niter_sublin << endl;
