...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::ugradu_initialization()
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: ugradu_initialization");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::calculate_row_indexes(FV_DiscreteField const *FF)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: calculate_row_indexes");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_field_matrix(FV_DiscreteField const *FF, FV_TimeIterator const *t_it)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_field_schur_matrix(FV_DiscreteField const *FF)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_1D_matrices(FV_DiscreteField const *FF, FV_TimeIterator const *t_it)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
{
    ...
    if (my_rank == is_master)
        SCT_set_start("Pressure stress");
    // if (is_stressCal && (t_it->iteration_number() % stressCalFreq == 0))
    // {
    //     allrigidbodies->compute_pressure_force_and_torque_for_allRB(PressureStressOrder);
    // }
    if (my_rank == is_master)
        SCT_get_elapsed_time("Pressure stress");
}

//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_velocity_diffusion_terms()
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: assemble_velocity_diffusion_terms");
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::compute_un_component(size_t const &comp,
                                               size_t const &i,
                                               size_t const &j,
                                               size_t const &k,
                                               size_t const &dir,
...
DLMFD_DirectionSplitting::compute_first_derivative(size_t const &comp,
                                                   size_t const &i,
                                                   size_t const &j,
                                                   size_t const &k,
                                                   size_t const &dir,
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: compute_first_derivative");

    size_t_array2D *intersect_vector = 0;
    doubleArray2D *intersect_distance = 0;
    doubleArray2D *intersect_fieldVal = 0;
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::compute_un_component_FD(size_t const &comp,
                                                  size_t const &i,
                                                  size_t const &j,
                                                  size_t const &k,
                                                  size_t const &dir,
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: compute_un_component_FD");
...
// //---------------------------------------------------------------------------
// double
// DLMFD_DirectionSplitting::compute_un_component_FV(size_t const &comp,
//                                                   size_t const &i,
//                                                   size_t const &j,
//                                                   size_t const &k,
//                                                   size_t const &dir,
...
// //---------------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting:: compute_un_component_FV");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::unpack_ue(size_t const &comp, double *received_data, size_t const &dir, size_t const &p, size_t const &field)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::solve_interface_unknowns(FV_DiscreteField *FF, double const &gamma, FV_TimeIterator const *t_it, size_t const &comp, size_t const &dir, size_t const &level)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::compute_adv_component(FV_TimeIterator const *t_it,
                                                size_t const &comp,
                                                size_t const &i,
                                                size_t const &j,
                                                size_t const &k)
...
//----------------------------------------------------------------------
double
DLMFD_DirectionSplitting::divergence_of_U_noCorrection(size_t const &i, size_t const &j, size_t const &k, size_t const &component, size_t const &level)
//----------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: divergence_of_U_noCorrection");
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::get_current_mean_flow_speed()
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplittingSystem:: get_current_mean_flow_speed");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::predicted_pressure_drop(FV_TimeIterator const *t_it)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: predicted_pressure_drop");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_DS_un_at_rhs(FV_TimeIterator const *t_it,
                                                     double const &gamma)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::Solve_i_in_jk(FV_DiscreteField *FF, FV_TimeIterator const *t_it, size_t const &dir_i, size_t const &dir_j, size_t const &dir_k, double const &gamma, size_t const &level)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::data_packing(FV_DiscreteField const *FF, size_t const &p, double const &fe, size_t const &comp, size_t const &dir)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
{
    ...
    UF->synchronize(3);
    // if (is_solids)
    //     initialize_grid_nodes_on_rigidbody({3});
    UF->set_neumann_DOF_values();
    ...
    // if (is_solids)
    //     initialize_grid_nodes_on_rigidbody({level});
    UF->set_neumann_DOF_values();
    ...
    if (dim == 3)
    {
        ...
        UF->synchronize(0);
        // if (is_solids)
        //     initialize_grid_nodes_on_rigidbody({0});
        UF->set_neumann_DOF_values();
    }
...
// //---------------------------------------------------------------------------
// void DLMFD_DirectionSplitting::initialize_grid_nodes_on_rigidbody(vector<size_t> const &list)
// //---------------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting::initialize_grid_nodes_on_rigidbody");
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::assemble_velocity_gradients(class doubleVector &grad, size_t const &i, size_t const &j, size_t const &k, size_t const &level)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: assemble_velocity_gradients");
...
//---------------------------------------------------------------------------
double
DLMFD_DirectionSplitting::calculate_velocity_divergence_FD(size_t const &i,
                                                           size_t const &j,
                                                           size_t const &k,
                                                           size_t const &level)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: calculate_velocity_divergence");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::assemble_velocity_advection_terms(FV_TimeIterator const *t_it)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: assemble_velocity_advection_terms");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::compute_velocity_divergence(FV_DiscreteField const *FF)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: compute_velocity_divergence");
...
// //---------------------------------------------------------------------------
// void DLMFD_DirectionSplitting::correct_pressure_1st_layer_solid(size_t const &level)
// //---------------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting:: correct_pressure_1st_layer_solid");
...
// //---------------------------------------------------------------------------
// void DLMFD_DirectionSplitting::correct_pressure_2nd_layer_solid(size_t const &level)
// //---------------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting:: correct_pressure_2nd_layer_solid");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::correct_mean_pressure(size_t const &level)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: correct_mean_pressure");
...
//----------------------------------------------------------------------
void DLMFD_DirectionSplitting::write_output_field(FV_DiscreteField const *FF)
//----------------------------------------------------------------------
{
    ofstream outputFile;
...
//----------------------------------------------------------------------
void DLMFD_DirectionSplitting::output_L2norm_divergence()
//----------------------------------------------------------------------
{
    size_t_vector min_unknown_index(dim, 0);
    size_t_vector max_unknown_index(dim, 0);
...
//----------------------------------------------------------------------
double
DLMFD_DirectionSplitting::compute_DS_velocity_change(void)
//----------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: compute_DS_velocity_change");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::create_DS_subcommunicators(void)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: create_DS_subcommunicators");
...
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: processor_splitting");
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::allocate_mpi_variables(FV_DiscreteField const *FF)
//---------------------------------------------------------------------------
{
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::deallocate_mpi_variables()
//---------------------------------------------------------------------------
{
    // Array declarations
...
//---------------------------------------------------------------------------
void DLMFD_DirectionSplitting::free_DS_subcommunicators(void)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: free_DS_subcommunicators");
}
...
//---------------------------------------------------------------------------
{
    ...
    case 0:
        if (translation_magnitude > 0.)
            outOfDomain_boundaryName = "right";
        else
            outOfDomain_boundaryName = "left";
        break;
    case 1:
        if (translation_magnitude > 0.)
            outOfDomain_boundaryName = "top";
        else
            outOfDomain_boundaryName = "bottom";
        break;
    case 2:
        if (translation_magnitude > 0.)
            outOfDomain_boundaryName = "front";
        else
            outOfDomain_boundaryName = "behind";
        break;
    }
...
//---------------------------------------------------------------------------
doubleVector
DLMFD_DirectionSplitting::compute_outOfDomain_Pressure(size_t const &level)
//---------------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: compute_outOfDomain_Pressure");
...
//----------------------------------------------------------------------
double
DLMFD_DirectionSplitting::assemble_advection_Centered(size_t const &advecting_level,
                                                      double const &coef,
...
//----------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: assemble_advection_Centered");
...
//----------------------------------------------------------------------
double
DLMFD_DirectionSplitting::assemble_advection_Centered_FD(double const &coef,
                                                         size_t const &i,
                                                         size_t const &j,
                                                         size_t const &k,
                                                         size_t const &comp,
...
//----------------------------------------------------------------------
{
    MAC_LABEL("DLMFD_DirectionSplitting:: assemble_advection_Centered_FD");
...
// //----------------------------------------------------------------------
// double
// DLMFD_DirectionSplitting::assemble_advection_Centered_CutCell(FV_TimeIterator const *t_it,
//                                                               double const &coef,
//                                                               size_t const &i,
//                                                               size_t const &j,
//                                                               size_t const &k,
...
// //----------------------------------------------------------------------
// {
//     MAC_LABEL("DLMFD_DirectionSplitting:: assemble_advection_Centered_CutCell");
...
//     color(0) = FV_BC_LEFT;
//     color(1) = FV_BC_RIGHT;
//     color(2) = FV_BC_BOTTOM;
//     color(3) = FV_BC_TOP;
//     if (dim == 3)
//     {
//         color(4) = FV_BC_BEHIND;
//         color(5) = FV_BC_FRONT;
//     }
