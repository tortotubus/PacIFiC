...
public: //------------------------------------------------------------------
    ...
    bool proximityQuery(DLMFD_RigidBody const *second_component, const double &distance) const;
    ...
    void allocate_default_listOfPointsAndVectors_3Dbox(const double &critical_distance, FV_DiscreteField *pField);
