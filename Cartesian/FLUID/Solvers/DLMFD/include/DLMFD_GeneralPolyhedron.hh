...
A moving or stationary rigid 3D box of axisymmetric cross-section in the Fictitious Domain solver.
...
public: //------------------------------------------------------------------
    ...
    DLMFD_GeneralPolyhedron(FS_RigidBody *pgrb,
    ...
    void setBndPts_IsometricCube(vector<geomVector> const &corners_,
                                 double spacing,
    ...
    void setBndPts_IsometricTetrahedron(vector<geomVector> const &corners_,
                                        double spacing,
                                        FV_Mesh const *primary_grid,
                                        list<DLMFD_BoundaryMultiplierPoint *>::iterator &bp,
                                        list<DLMFD_BoundaryMultiplierPoint *>::iterator &bphz);
    ...
    FS_GeneralPolyhedron_Additional_Param const *get_ptr_FS_GeneralPolyhedron_Additional_Param();
    ...
    void allocate_default_listOfPointsAndVectors_GeneralPolyhedron(const double &critical_distance, FV_DiscreteField *pField);
...
protected: //----------------------------------------------------------------
    ...
    FS_GeneralPolyhedron_Additional_Param const *pagp; /** Pointer to FS GeneralPolyhedron parameters */
