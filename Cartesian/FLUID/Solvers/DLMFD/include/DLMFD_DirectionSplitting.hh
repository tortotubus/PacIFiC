#ifndef DLMFD_DirectionSplitting_HH
#define DLMFD_DirectionSplitting_HH
#include <mpi.h>
...
class LA_Vector;
class LA_SeqVector;
class DLMFD_DirectionSplittingSystem;
class LA_SeqMatrix;

/** @brief The Class DLMFD_DirectionSplitting.
...
class DLMFD_DirectionSplitting : public FV_OneStepIteration, public ComputingTime, public SolverComputingTime
{
public: //-----------------------------------------------------------------
...
private:   //----------------------------------------------------------------
    ...
    DLMFD_DirectionSplitting &operator=(DLMFD_DirectionSplitting const &other);

    /** @brief Constructor with arguments
    @param a_owner the MAC-based object
    @param exp to read the data file */
    DLMFD_DirectionSplitting(MAC_Object *a_owner,
