...
struct FS_2Dbox_Additional_Param
{
...
/** @brief The class FS_2Dbox.

A moving or stationary rigid 2D cylinder of axisymmetric cross-section.

@author A. Wachs - Pacific project 2021 */

class FS_2Dbox: public FS_RigidBody
{
   public: //-----------------------------------------------------------------
   ...
   //-- Constructors & Destructor
      ...
      FS_2Dbox( istream& in, size_t& id_ );
   ...
   //-- Get methods
      ...
      struct FS_2Dbox_Additional_Param const*
   ...
   //-- Methods
      ...
      /** @brief Reverse tranform the corners of the actual 2D box to the
      reference 2D box
      @param pt point to transform */
      void compute_reverseTransformationOfCorners( );

      /** @brief Tranform the corners of the reference 2D box to the
      actual 2D box
      @param pt point to transform */
   ...
   //-- Attributes
      ...
      /**@name Parameters */
      //@{
      struct FS_2Dbox_Additional_Param m_agp_2dbox; /**< Additional
      	geometric parameters for the 2D cylinder */
      //@}
   ...
   //-- Constructors & Destructor
      ...
      @param copy copied FS_2Dbox object */
      FS_2Dbox( FS_2Dbox const& copy );
      //@}
