#ifndef _FS_3DSPHEROIDCYLINDER__
#define _FS_3DSPHEROIDCYLINDER__
...
struct FS_3Dspheroidcylinder_Additional_Param
{
...
class FS_3Dspheroidcylinder: public FS_RigidBody
{
   ...
   //-- Get methods
      ...
      struct FS_3Dspheroidcylinder_Additional_Param const*
   ...
   //-- Methods
      ...
      /** @brief Calculates the intersection with the spherical part of
   ...
   //-- Attributes
      ...
      /**@name Parameters */
      //@{
      struct FS_3Dspheroidcylinder_Additional_Param m_agp_3dcyl; /**< Additional
   ...
   //-- Constructors & Destructor
      ...
      @param copy copied FS_3Dspheroidcylinder object */
      FS_3Dspheroidcylinder( FS_3Dspheroidcylinder const& copy );
      //@}
